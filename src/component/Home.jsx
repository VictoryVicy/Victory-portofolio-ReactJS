...
export default function Home() {
  return (
    <section id="home" className="sm:mt-8 mt-12">
      <div className="container m-auto px-12 pt-12 sm:py-32 flex flex-col sm:flex-row gap-16">
        <div>
          ...
          <p className="mt-4 text-gray-400 mt-8">
        ...
        <div className="relative">
          <img
            src={Profile}
            alt="Victory"
            className="rounded-full relative w-[300px] m-auto sm:w-[2000px]"
          />
        </div>
      </div>
    </section>
